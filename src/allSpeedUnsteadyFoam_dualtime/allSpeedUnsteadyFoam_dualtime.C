...
Description
    ...
    TODO: Improve the operation of preconditioning matrix.
		  ddt scheme about dual time should be developed modified 
		  base on the form within OpenFOAM. 
	...
	S.J. Zhang, A. Meganathan, "Preconditioning methods in CFD-FASTRAN", 
	AIAA(2008)2008-701. 

	This is just a version that might work. For estension or maintainability 
	of this program, the operation of preconditioning matrix and the ddt scheme 
	about dual time should be improved futher according to the high level code 
	within OpenFOAM.
